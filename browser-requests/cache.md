...
\
This will save you time waiting for the response, as well as credits because requests returned from the cache directly are billed [at a reduced rate](../your-account/credits.md).
